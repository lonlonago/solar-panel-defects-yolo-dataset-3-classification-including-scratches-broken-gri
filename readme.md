# Solar Panel Defects YOLO Dataset】3-Classification Including Scratches Broken Grids and

# Body

Solar Panel Defects YOLO Dataset】3-class classification, including scratches, breakage, and dirt defects. The dataset consists of 2400 images. The dataset is divided as 7:2:1 for training, validation, and testing. There are 1600 images in the training set, 480 images in the validation set, and 240 images in the test set. All image samples are labeled with txt under YOLO. You can directly train the code after obtaining the code. If you have any interest, please contact me.
